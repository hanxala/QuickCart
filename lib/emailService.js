      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>QuickCart - Admin Notification</p>
          </div>
          <div class="content">
            <div class="order-info">
              ...
              <p><strong>Status:</strong> <span class="status">${orderData.orderStatus}</span></p>
            ...
            <div class="footer">
              <p>This is an automated notification from QuickCart Admin System</p>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>QuickCart - Inventory Notification</p>
          </div>
          <div class="content">
            <div class="alert">
              <h2>${product.name}</h2>
...
class EmailService {
  ...
  async sendEmail(to, subject, html, text) {
    ...
    const mailOptions = {
      from: `QuickCart Admin <${process.env.ADMIN_EMAIL}>`,
      to,
      subject,
      html,
      text
