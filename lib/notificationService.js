...
class NotificationService {
  ...
  async sendNotification(type, title, message, data = {}) {
    try {
      ...
      // Add internal secret for server-to-server authentication
      if (process.env.NOTIFICATIONS_INTERNAL_SECRET) {
        headers['X-Internal-Secret'] = process.env.NOTIFICATIONS_INTERNAL_SECRET;
      }
